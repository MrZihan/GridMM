    ...
    def _eval_checkpoint(
        ...
        while envs.num_envs > 0 and len(stats_episodes) < episodes_to_eval:
            ...
            with torch.no_grad():
                if 'CMA' in self.config.MODEL.policy_name:
                    ...
                    if stepk == 0:
                        ...
                        self.policy.net.start_headings = [(heading+2*math.pi)%(2*math.pi) for heading in headings]
            ...
            for i in range(envs.num_envs):
                ...
                GLOBAL_STEP += 1
                print('sr:',GLOBAL_SR/GLOBAL_STEP,' osr:',GLOBAL_OSR/GLOBAL_STEP, ' spl:',GLOBAL_SPL/GLOBAL_STEP)
