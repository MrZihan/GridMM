...
def parse_args():
    ...
    parser.add_argument('--tokenizer', choices=['bert', 'xlm'], default='xlm')
    ...
    parser.add_argument('--expl_max_ratio', type=float, default=0.5)
...
def postprocess_args(args):
    ...
    args.img_ft_file = os.path.join(ROOTDIR, 'R2R', 'features')
