...
class GlocalTextPathCMT(BertPreTrainedModel):
    ...
    def forward(
        ...
        gmap_lens, gmap_step_ids, gmap_pos_fts, gmap_pair_dists, gmap_vpids, vp_pos_fts, grid_fts, grid_map, target_patch_id=None, gridmap_pos_fts=None,
        ...
        for b in range(batch_size):
            ...
            for i in range(14*14):
                ...
                grid_map_input[b,i] = (cell_fts * torch.softmax(grid_fts_weight[grid_map[b]==i],dim=-1).unsqueeze(-1)).sum(-2).to(torch.float32)
